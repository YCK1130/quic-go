...
//
//	mockgen -typed -package quic -self_package github.com/YCK1130/quic-go -self_package github.com/YCK1130/quic-go -destination mock_packetconn_test.go net PacketConn
//
