...
a remote execution exploit -- please [**report privately**](https://github.com/YCK1130/quic-go/security/advisories/new).
...
For non-security bugs, please simply file a GitHub [issue](https://github.com/YCK1130/quic-go/issues/new).
